...
# > from tcutils.error import FailError
...
def dns_odoh(odoh_ddr, ddrRType, resolver, http_method, domain_name, rr_type, dns_queryid=0, edns=False):
    """
    ...
    response, odoh_target_ip = SVCB_DNS_Request(odoh_ddr, ddrRType, resolver)
